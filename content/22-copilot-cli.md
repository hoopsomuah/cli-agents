...
hero_image: "loops-06-agents-parallel-reading.png"
hero_image_alt: "Warm watercolor workshop titled 'You + your agents, in parallel — worktrees turn one human into a workshop.' Ada sits at a central desk while dashed lines run from a '.git' book on the shelf to four small agents, each at its own table with its own task: Cog ('recipe/sourdough'), Quill ('letter/to-amara'), Loom ('garden/spring-bed') and Ember ('playlist/road-trip')."
hero_image_caption: "One human, several agents — each working its own task in parallel."
deck_image: "loops-06-agents-parallel-deck.png"
deck_image_alt: "Cinematic staging of one human directing four agents — Cog, Quill, Loom and Ember — each at its own worktree, lit for projection."
deck_image_caption: "You stay in the centre. Each agent runs its own loop."
